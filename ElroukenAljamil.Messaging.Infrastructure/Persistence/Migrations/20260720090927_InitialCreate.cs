        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnreadCountBuyer = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    UnreadCountSeller = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_BuyerId_SellerId_ListingId",
                table: "Conversations",
                columns: new[] { "BuyerId", "SellerId", "ListingId" },
                unique: true);
