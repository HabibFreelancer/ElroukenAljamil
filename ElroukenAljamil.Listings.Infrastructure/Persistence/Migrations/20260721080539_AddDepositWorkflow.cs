        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibilityCondition = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepositWorkflows_IsActive",
                table: "DepositWorkflows",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_StepFields_StepId_DisplayOrder",
                table: "StepFields",
                columns: new[] { "StepId", "DisplayOrder" });
