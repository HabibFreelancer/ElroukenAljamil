-- ============================================
-- 021: Seed Deposit Workflow for "Véhicules > Équipement nautisme"
-- Details step has multiselect with nautical equipment types
-- ============================================
...
BEGIN
    ...
    VALUES (@CategoryId, N'Depot Equipement Nautisme', N'Workflow pour deposer une annonce equipement nautisme', 1, GETUTCDATE());
    ...
    (@WorkflowId, 3, N'Dites-nous en plus', N'Selectionnez le type d''equipement nautique.', 'details', 1, 1),
    ...
    VALUES (@StepTitle, 'title', N'Titre de l''annonce', 'text', N'Ex: Remorque bateau 750kg galvanisee', '', '', '', '', 1, 1, 1, 200, '');

    -- Step: Details (1 field - multiselect)
    INSERT INTO StepFields (StepId, FieldKey, Label, FieldType, Placeholder, Options, DefaultValue, Suffix, HelperText, IsRequired, DisplayOrder, IsActive, MaxLength, ValidationRegex)
    VALUES (@StepDetails, 'equipmentType', N'Type d''equipement nautique', 'multiselect', N'Selectionnez',
     N'[{"value":"remorque_bateau","label":"Remorque de bateau"},{"value":"emplacement_bateau","label":"Emplacement bateau"},{"value":"equipements_bateau","label":"Equipements bateau"},{"value":"autre","label":"Autre"}]',
     '', '', '', 1, 1, 1, NULL, '');

    -- Step: Description (AI disabled)
    ...
    (@StepDesc, 'description', N'Titre de l''annonce', 'text_counter', N'Ex: Remorque bateau galvanisee 750kg', '', '', '', '', 1, 1, 1, 200, ''),
    (@StepDesc, 'annonce_description', N'Description de l''annonce', 'textarea_counter', N'Decrivez votre equipement : marque, dimensions, capacite, etat...', '', '', '', '', 1, 2, 1, 4000, '');

    -- Step: Price
    INSERT INTO StepFields (StepId, FieldKey, Label, FieldType, Placeholder, Options, DefaultValue, Suffix, HelperText, IsRequired, DisplayOrder, IsActive, MaxLength, ValidationRegex)
    VALUES (@StepPrice, 'price', N'Votre prix de vente', 'price_gauge', N'Ex: 800', '', '', 'TND', '', 1, 1, 1, NULL, '');
    ...
    PRINT 'Workflow "Equipement Nautisme" created with 7 steps and 8 fields.';
END
ELSE
