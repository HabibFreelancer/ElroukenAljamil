...
BEGIN
    ...
    (@StepDetails, 'volume', N'Volume de chargement', 'select', N'Choisissez',
     N'[{"value":"petit","label":"Petit utilitaire (3 a 5 m3)"},{"value":"moyen","label":"Utilitaire moyen (5 a 9 m3)"},{"value":"grand","label":"Grand utilitaire (9 a 12 m3)"},{"value":"autre","label":"Autre"}]',
     '', '', N'Volume utile de l''espace de chargement en metres cubes.', 0, 15, 1, NULL, ''),
    (@StepDetails, 'ptac', N'PTAC', 'select', N'Choisissez',
     N'[{"value":"2_4","label":"<= 2,4 t"},{"value":"2_4_3_5","label":"> 2,4 a 3,5 t"},{"value":"3_5_plus","label":"> 3,5 t"},{"value":"autre","label":"Autre"}]',
    ...
    (@StepDetails, 'classeEmission', N'Classe d''emission', 'select', N'Choisissez',
     N'[{"value":"euro1","label":"Euro 1"},{"value":"euro2","label":"Euro 2"},{"value":"euro3","label":"Euro 3"},{"value":"euro4","label":"Euro 4"},{"value":"euro5","label":"Euro 5"},{"value":"euro6","label":"Euro 6"},{"value":"autre","label":"Autre"}]',
     '', '', '', 0, 25, 1, NULL, '');
