...
BEGIN
    ...
    (@StepDetails, 'carrosserie', N'Carrosserie specifique', 'select', N'Choisissez',
     ...
     '', '', '', 0, 9, 1, NULL, ''),
    (@StepDetails, 'transmission', N'Transmission', 'radio', N'',
    ...
    (@StepDetails, 'finition', N'Finition', 'text', N'Ex: Confort, Grand Confort...', '', '', '', '', 0, 17, 1, 100, ''),
    (@StepDetails, 'version', N'Version', 'text', N'Ex: L2H2, L3H2...', '', '', '', '', 0, 18, 1, 100, ''),
