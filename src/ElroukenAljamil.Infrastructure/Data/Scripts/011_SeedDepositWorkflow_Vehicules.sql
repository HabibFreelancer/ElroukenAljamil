...
BEGIN
    ...
    (@StepDetails, 'fuel', N'Energie', 'pills', N'', N'[{"value":"essence","label":"Essence"},{"value":"diesel","label":"Diesel"},{"value":"hybride","label":"Hybride"},{"value":"hybride_rechargeable","label":"Hybride Rechargeable"},{"value":"electrique","label":"Electrique"},{"value":"gpl","label":"GPL"},{"value":"gnv","label":"Gaz Naturel (GNV)"},{"value":"autre","label":"Autre"}]', '', '', '', 1, 7, 1, NULL, ''),
    (@StepDetails, 'gearbox', N'Boite de vitesse', 'radio', N'', N'[{"value":"manuelle","label":"Manuelle"},{"value":"automatique","label":"Automatique"}]', '', '', '', 1, 8, 1, NULL, ''),
    (@StepDetails, 'vehicleType', N'Type de vehicule', 'select', N'Choisissez', N'[{"value":"berline","label":"Berline"},{"value":"break","label":"Break"},{"value":"cabriolet","label":"Cabriolet"},{"value":"citadine","label":"Citadine"},{"value":"coupe","label":"Coupe"},{"value":"monospace","label":"Monospace"},{"value":"suv","label":"4x4, SUV & Crossover"},{"value":"utilitaire","label":"Utilitaire"},{"value":"autre","label":"Autre"}]', '', '', '', 0, 9, 1, NULL, ''),
    (@StepDetails, 'doors', N'Nombre de portes', 'select', N'Choisissez', N'[{"value":"2","label":"2"},{"value":"3","label":"3"},{"value":"4","label":"4"},{"value":"5","label":"5"}]', '', '', '', 0, 10, 1, NULL, ''),
    (@StepDetails, 'seats', N'Nombre de places', 'select', N'Choisissez', N'[{"value":"2","label":"2"},{"value":"4","label":"4"},{"value":"5","label":"5"},{"value":"6","label":"6"},{"value":"7","label":"7"},{"value":"8","label":"8"},{"value":"9","label":"9+"}]', '', '', '', 0, 11, 1, NULL, ''),
    (@StepDetails, 'fiscalPower', N'Puissance fiscale', 'number', N'0', '', '', 'CV', N'Puissance fiscale de votre vehicule.', 0, 12, 1, NULL, ''),
    (@StepDetails, 'dinPower', N'Puissance DIN', 'number', N'0', '', '', 'Ch', N'Puissance moteur en chevaux DIN.', 0, 13, 1, NULL, ''),
    (@StepDetails, 'mileage', N'Kilometrage', 'number', N'0', '', '', 'km', '', 1, 14, 1, NULL, ''),
    (@StepDetails, 'color', N'Couleur', 'select', N'Choisissez', N'[{"value":"noir","label":"Noir"},{"value":"blanc","label":"Blanc"},{"value":"gris","label":"Gris"},{"value":"bleu","label":"Bleu"},{"value":"rouge","label":"Rouge"},{"value":"vert","label":"Vert"},{"value":"beige","label":"Beige"},{"value":"marron","label":"Marron"},{"value":"orange","label":"Orange"},{"value":"jaune","label":"Jaune"},{"value":"autre","label":"Autre"}]', '', '', '', 0, 15, 1, NULL, ''),
    (@StepDetails, 'upholstery', N'Sellerie', 'multiselect', N'Selectionnez', N'[{"value":"tissu","label":"Tissu"},{"value":"cuir","label":"Cuir"},{"value":"alcantara","label":"Alcantara"},{"value":"semi_cuir","label":"Semi-cuir"},{"value":"simili","label":"Simili cuir"},{"value":"velours","label":"Velours"},{"value":"autre","label":"Autre"}]', '', '', '', 0, 16, 1, NULL, ''),
    (@StepDetails, 'equipment', N'Equipements', 'multiselect', N'Selectionnez', N'[{"value":"climatisation","label":"Climatisation"},{"value":"gps","label":"GPS"},{"value":"bluetooth","label":"Bluetooth"},{"value":"camera_recul","label":"Camera de recul"},{"value":"radar_stationnement","label":"Radar de stationnement"},{"value":"siege_chauffant","label":"Sieges chauffants"},{"value":"toit_ouvrant","label":"Toit ouvrant"},{"value":"regulateur","label":"Regulateur de vitesse"},{"value":"start_stop","label":"Start & Stop"},{"value":"jantes_alu","label":"Jantes aluminium"},{"value":"led","label":"Phares LED"},{"value":"keyless","label":"Demarrage sans cle"},{"value":"apple_carplay","label":"Apple CarPlay"},{"value":"android_auto","label":"Android Auto"}]', '', '', '', 0, 17, 1, NULL, ''),
    (@StepDetails, 'history', N'Historique et entretien', 'multiselect', N'Selectionnez', N'[{"value":"premiere_main","label":"Premiere main"},{"value":"carnet_entretien","label":"Carnet d''entretien"},{"value":"revision_jour","label":"Revision a jour"},{"value":"non_fumeur","label":"Non fumeur"},{"value":"garage","label":"Gare en garage"},{"value":"ct_ok","label":"Controle technique OK"},{"value":"import","label":"Vehicule importe"},{"value":"accident","label":"Vehicule accidente"}]', '', '', '', 0, 18, 1, NULL, ''),
    (@StepDetails, 'vehicleState', N'Etat du vehicule', 'select', N'Choisissez', N'[{"value":"neuf","label":"Neuf"},{"value":"tres_bon","label":"Tres bon etat"},{"value":"bon","label":"Bon etat"},{"value":"correct","label":"Etat correct"},{"value":"accident","label":"Accidente / Pour pieces"}]', '', '', '', 0, 19, 1, NULL, ''),
    (@StepDetails, 'license', N'Permis', 'radio', N'', N'[{"value":"avec","label":"Avec permis"},{"value":"sans","label":"Sans permis"}]', 'avec', '', '', 0, 20, 1, NULL, '');
    ...
    PRINT 'Workflow "Vehicules > Voitures" created with 7 steps and 27 fields.';
END
ELSE
