-- ============================================
-- 018: Seed Deposit Workflow for "Véhicules > Équipement auto"
-- Same as Voitures but details step only has a multiselect type field
-- ============================================

DECLARE @CategoryId INT = 24;
...
BEGIN
    ...
    VALUES (@CategoryId, N'Depot Equipement Auto', N'Workflow pour deposer une annonce equipement auto', 1, GETUTCDATE());
    ...
    (@WorkflowId, 3, N'Dites-nous en plus', N'Selectionnez le type d''equipement.', 'details', 1, 1),
    ...
    VALUES (@StepTitle, 'title', N'Titre de l''annonce', 'text', N'Ex: Jantes alu 17 pouces BMW', '', '', '', '', 1, 1, 1, 200, '');

    -- Step: Details (1 field - multiselect type)
    INSERT INTO StepFields (StepId, FieldKey, Label, FieldType, Placeholder, Options, DefaultValue, Suffix, HelperText, IsRequired, DisplayOrder, IsActive, MaxLength, ValidationRegex)
    VALUES (@StepDetails, 'equipmentType', N'Type d''equipement', 'multiselect', N'Selectionnez',
     N'[{"value":"hifi_navigation","label":"Systeme Hi-fi & Navigation"},{"value":"remplacement_reparation","label":"Remplacement et reparation de vehicules"},{"value":"pneus_jantes","label":"Pneus & jantes"},{"value":"tuning","label":"Tuning"},{"value":"outils","label":"Outils"},{"value":"autres","label":"Autres"}]',
     '', '', '', 1, 1, 1, NULL, '');
    ...
    (@StepDesc, 'description', N'Titre de l''annonce', 'text_counter', N'Ex: Jantes alu 17 pouces BMW Serie 3', '', '', '', '', 1, 1, 1, 200, ''),
    (@StepDesc, 'annonce_description', N'Description de l''annonce', 'textarea_counter', N'Decrivez votre equipement : marque, compatibilite, etat...', '', '', '', '', 1, 2, 1, 4000, '');

    -- Step: Price
    INSERT INTO StepFields (StepId, FieldKey, Label, FieldType, Placeholder, Options, DefaultValue, Suffix, HelperText, IsRequired, DisplayOrder, IsActive, MaxLength, ValidationRegex)
    VALUES (@StepPrice, 'price', N'Votre prix de vente', 'price_gauge', N'Ex: 500', '', '', 'TND', '', 1, 1, 1, NULL, '');
    ...
    PRINT 'Workflow "Equipement Auto" created with 7 steps and 8 fields.';
END
ELSE
